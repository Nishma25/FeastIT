...
import { ArrowLeft, Mail, Phone, MapPin, CheckCircle, XCircle, Clock } from 'lucide-react';
...
const VendorDetailPage = () => {
  ...
  const [popup, setPopup] = useState({ visible: false, type: "warning", message: "" });
          ...
          <div className="vendor-card">
            <div className="vendor-header">
              <div>
                ...
                <p className="status-text">Status: <span className={`badge ${vendor.vendor_status}`}>{vendor.vendor_status}</span></p>
              </div>
            ...
            <div className="vendor-section">
              ...
              <p><strong>Description:</strong> {vendor.vendor_description || 'N/A'}</p>
              <p><strong>Tax ID:</strong> {vendor.vendor_taxId || 'N/A'}</p>
            </div>

            <div className="vendor-section">
              <h4>Contact Information</h4>
              <p><MapPin size={16} /> {vendor.vendor_address}</p>
              <p><Clock size={16} /> {vendor.business_hours || 'Business hours not available'}</p>
              <p><Phone size={16} /> {vendor.vendor_phone}</p>
              <p><Mail size={16} /> {vendor.vendor_email}</p>
            </div>
            ...
            <div className="vendor-section">
              ...
              {vendor.vendor_rejectedmessage && <p><strong>Rejection Reason:</strong> {vendor.vendor_rejectedmessage}</p>}
            </div>
